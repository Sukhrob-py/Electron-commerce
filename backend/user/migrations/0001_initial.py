    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_role', models.CharField(choices=[('ordinary_user', 'ordinary_user'), ('admin', 'admin'), ('super_admin', 'super_admin')], default='ordinary_user', max_length=50)),
                ('phone_number', models.CharField(max_length=12, null=True, unique=True, validators=[django.core.validators.RegexValidator(message='Raqamingiz notogri formatda kiritildi. Masalan: 998993451545', regex='^^998[0-9]{9}$')])),
